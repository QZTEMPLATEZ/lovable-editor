...
const IntroScreen = ({ onComplete }: IntroScreenProps) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-editor-bg via-editor-bg/95 to-editor-bg relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative container mx-auto px-4 py-12 min-h-screen flex flex-col items-center justify-center">
        <GeometricShapes />
        <NeuralNetwork />
        <IntroText text="Welcome to Wedding Video Editor" />
