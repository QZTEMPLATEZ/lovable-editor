    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between h-full w-full px-6 md:px-12">
        <div className="space-y-0.5">
          <motion.h2 
            className="text-3xl md:text-5xl font-cinzel tracking-wider text-white"
          ...
          <motion.p 
            className="text-[7px] md:text-[9px] tracking-[0.2em] uppercase text-gray-400 font-italiana"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
          ...
          <motion.p 
            className="text-[7px] md:text-[9px] text-gray-400 max-w-md line-clamp-2"
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
        ...
        >
          <Button 
            variant="outline" 
            className="border-2 border-white text-white hover:bg-white/10 uppercase tracking-wider text-[9px] md:text-xs px-4 py-3"
          >
            SELECT
          </Button>
        </motion.div>
