...
const AIScriptWindow = ({ value, onChange }: AIScriptWindowProps) => {
  const suggestions = ['Cinematic', 'Fast-paced', 'Dramatic', 'Smooth'];
    ...
    <div className="space-y-6 bg-editor-bg/80 backdrop-blur-xl rounded-xl border border-purple-500/20 p-6">
      ...
      >
        <Textarea
          ...
          className="min-h-[200px] bg-purple-500/5 border border-purple-500/20 rounded-xl p-4 text-purple-100 
                   placeholder:text-purple-300/50 focus:border-purple-500/50 focus:ring-purple-500/20"
        />
      ...
      <div className="grid grid-cols-2 gap-4">
        {suggestions.map((style) => (
          <motion.button
            ...
            className="px-4 py-2 rounded-lg bg-purple-500/10 hover:bg-purple-500/20 border border-purple-500/30 
