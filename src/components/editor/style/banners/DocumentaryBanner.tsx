...
const DocumentaryBanner = ({ style, isHovered, onSelect }: DocumentaryBannerProps) => {
  ...
  return (
    <div className="relative w-full [aspect-ratio:3.84/1] group cursor-pointer bg-editor-panel isolate overflow-hidden">
      ...
      <StylePreview
        videoUrl="https://www.dropbox.com/scl/fi/rxab2rc98t7ox9hxcrb4b/251219_Urban-Couple-Photoshoot-Photography_By_Azulroto_Artlist_4K.mp4?raw=1"
        isHovered={isHovered}
        videoRef={videoRef}
      ...
      <div className="absolute inset-0 z-[5] flex items-center justify-between h-full w-full px-8 md:px-16">
        <StyleContent
          ...
          isHovered={isHovered}
          features={['Natural lighting', 'Authentic moments', 'Journalistic approach', 'Real emotions']}
        />
