...
const ModernBanner = ({ style, isHovered, onSelect }: ModernBannerProps) => {
  ...
  return (
    <div className="relative w-full [aspect-ratio:3.84/1] group cursor-pointer bg-editor-panel isolate overflow-hidden">
      ...
      <StylePreview
        videoUrl="https://www.dropbox.com/scl/fi/ng9ndcl10lcownk1mtx4g/CINEMATOGRAFICO-LONG-OK.mp4?raw=1"
        isHovered={isHovered}
        videoRef={videoRef}
      ...
      <div className="absolute inset-0 z-[5] flex items-center justify-between h-full w-full px-8 md:px-16">
        <StyleContent
          ...
          isHovered={isHovered}
          features={['Contemporary aesthetics', 'Modern transitions', 'Bold color grading', 'Dynamic pacing']}
        />
