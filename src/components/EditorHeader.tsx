    ...
    <div className="min-h-screen bg-gradient-to-b from-editor-bg to-editor-bg/95 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center space-y-8 mb-16">
          <div className="inline-flex items-center gap-3 px-6 py-2.5 bg-purple-500/10 rounded-full animate-fade-in">
          ...
          <p className="text-lg text-purple-200/70 max-w-2xl mx-auto">
            Select the ideal length for your wedding video. Each option is carefully designed to capture your special moments in the most meaningful way.
          </p>
        </div>
              ...
              >
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    ...
                    {index === 2 && (
                      <div className="p-3 bg-gradient-to-r from-purple-700 to-pink-700 rounded-full shadow-lg">
                        <Trophy className="w-6 h-6 text-white" />
                      </div>
                    )}
                    {index === 3 && (
                      <div className="p-3 bg-gradient-to-r from-purple-800 to-pink-800 rounded-full shadow-lg">
                  ...
                  {/* Package Labels */}
                  {index === 0 && (
                    <Badge variant="secondary" className="absolute -top-3 right-4 text-[10px] bg-gradient-to-r from-purple-400 to-pink-400 text-white font-medium px-3 py-0.5 shadow-lg rounded-full border border-white/10">
                      STARTER
                    </Badge>
                  )}
                  {index === 1 && (
                    <Badge variant="secondary" className="absolute -top-3 right-4 text-[10px] bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium px-3 py-0.5 shadow-lg rounded-full border border-white/10">
                      PREMIUM
                    </Badge>
                  )}
                  {index === 2 && (
                    <Badge variant="secondary" className="absolute -top-3 right-4 text-[10px] bg-gradient-to-r from-purple-700 to-pink-700 text-white font-medium px-3 py-0.5 shadow-lg rounded-full border border-white/10">
                      LUXURY
                    </Badge>
                  )}
                  {index === 3 && (
                    <Badge variant="secondary" className="absolute -top-3 right-4 text-[10px] bg-gradient-to-r from-purple-800 to-pink-800 text-white font-medium px-3 py-0.5 shadow-lg rounded-full border border-white/10">
                      ULTIMATE
                    </Badge>
                  )}
                  ...
                  <div className="mt-8 text-center">
                    <span className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-purple-200 group-hover:from-white group-hover:to-white transition-colors">
                      {duration.min}-{duration.max}
                    </span>
                    <span className="text-lg text-white/90 ml-1">min</span>
                  </div>
                  
                  <span className="text-sm text-purple-200/80 group-hover:text-white/90 transition-colors text-center max-w-[200px] mt-2">
